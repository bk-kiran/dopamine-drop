...
import { LayoutDashboard, BookOpen, Calendar, User, Trophy, GraduationCap, ChevronLeft, ChevronRight } from 'lucide-react'
...
const navItems = [
  ...
  { name: 'Grades', icon: GraduationCap, href: '/dashboard/grades' },
